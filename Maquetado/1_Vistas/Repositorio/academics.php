...
<head>
  ...
  <meta name="keywords" content="repositorio, generacion, itssmt, proyectos">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Repositorio</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="academics.php">Por Generacion</a></li>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">
                Encuentra los proyectos integradores de cada generación de egresados.
              </p>
            </div>
          </div>
        </div>
