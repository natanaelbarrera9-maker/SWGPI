...
<body class="admissions-page">
  ...
  <main class="main">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">Explora los proyectos integradores organizados por cada una de las carreras del ITSSMT.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="admissions" class="admissions section">
      <div class="container">
        <p>Aquí se mostrará el contenido del repositorio filtrado por carrera.</p>
      </div>
    </section>
