...
<body class="faculty-staff-page">
  ...
  <main class="main">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">Busca proyectos integradores por áreas de interés o temas específicos.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="faculty-staff" class="faculty-staff section">
      <div class="container">
        <p>Aquí se mostrará el contenido del repositorio filtrado por temas.</p>
      </div>
    </section>
