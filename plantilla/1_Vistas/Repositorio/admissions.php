...
<head>
  ...
  <title>Repositorio por Carrera - SWGPI</title>
  <meta name="description" content="Repositorio de proyectos integradores filtrado por carrera.">
  <meta name="keywords" content="repositorio, carrera, itssmt, proyectos">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Repositorio</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="admissions.php">Por Carrera</a></li>
              <li><a href="academics.html">Por Generacion</a></li>
              <li><a href="faculty-staff.html">Temas</a></li>
            </ul>
          </li>
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 class="heading-title">Repositorio por Carrera</h1>
              <p class="mb-0">
                Explora los proyectos integradores organizados por cada una de las carreras del ITSSMT.
              </p>
            </div>
          </div>
        </div>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Por Carrera</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
