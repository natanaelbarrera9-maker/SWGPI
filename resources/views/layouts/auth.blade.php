    ...
    <style>
        ...
        * {
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(45, 90, 150, 0.25);
        }
        ...
        .welcome-nav a.btn-primary {
            background: linear-gradient(135deg, var(--primary-blue) 0%, var(--secondary-blue) 100%);
            color: white;
        }

        .welcome-nav a.btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(27, 57, 106, 0.3);
        }

        .welcome-nav a.btn-secondary {
            background-color: white;
            color: var(--primary-blue);
            border: 2px solid var(--primary-blue);
        }

        .welcome-nav a.btn-secondary:hover {
            background-color: var(--light-bg);
        }
...
<body>
    <!-- Welcome background -->
    <div class="welcome-container" id="welcome-bg">
        <div class="welcome-content">
            ...
            <div class="welcome-nav">
                ...
                <a href="#about" class="btn-secondary">Saber Más</a>
            </div>
        </div>
    </div>
